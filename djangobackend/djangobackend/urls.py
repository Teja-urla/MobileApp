...
from api.views import ImagesList, LoginView, UserView, UserProjectList, ProjectImageList, ProjectImageUpload, test_cors, TrainYOLO
...
urlpatterns = [
    ...
    path('yolo-models/', TrainYOLO.as_view({'post': 'trainYoloModel'}), name='yolo-model-list'),
